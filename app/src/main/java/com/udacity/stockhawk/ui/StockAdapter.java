...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    public void onBindViewHolder(StockViewHolder holder, int position) {
        ...
        if (rawAbsoluteChange > 0) {
            ...
            contentDescriptionChange = context.getString(R.string.description_price_up_by);
        } else {
            holder.change.setBackgroundResource(R.drawable.percent_change_pill_red);
            contentDescriptionChange = context.getString(R.string.description_price_down_by);
        }
        ...
        if (Utils.getDisplayMode(context)
            ...
            holder.change.setContentDescription(contentDescriptionChange);
        } else {
