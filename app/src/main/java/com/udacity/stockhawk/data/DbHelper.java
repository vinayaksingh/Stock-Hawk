...
class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String builder = "CREATE TABLE " + Quote.TABLE_NAME + " ("
                ...
                + Quote.COLUMN_HISTORY_ONE_YEAR + " TEXT NOT NULL, "
                + Quote.COLUMN_HISTORY_SIX_MONTHS + " TEXT NOT NULL, "
                + Quote.COLUMN_HISTORY_THREE_MONTHS + " TEXT NOT NULL, "
                + Quote.COLUMN_HISTORY_ONE_MONTH + " TEXT NOT NULL, "
                + Quote.COLUMN_HISTORY_ONE_WEEK + " TEXT NOT NULL, "
